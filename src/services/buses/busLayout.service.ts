...
import type { BusLayout, CreateBusLayoutDTO, UpdateBusLayoutDTO } from '@/types/buses/busLayout'
...
const busLayoutsApiService = createApiService<BusLayout, CreateBusLayoutDTO, UpdateBusLayoutDTO>('/busLayouts')
